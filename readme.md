...
public sealed class UserService : IUserService
{
    ...
    public async Task<IDataResult<long>> AddAsync(AddUserModel addUserModel)
    {
        ...
        UserDomainService.GenerateHashForLoginAndPassword(addUserModel.SignIn);
    ...
    public async Task<IDataResult<SignedInModel>> SignInAsync(SignInModel signInModel)
    {
        ...
        UserDomainService.GenerateHashForLoginAndPassword(signInModel);
...
public class UserDomainService : IUserDomainService
{
    ...
    public void GenerateHashForLoginAndPassword(SignInModel signInModel)
    {
